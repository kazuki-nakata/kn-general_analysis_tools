...
class Level0File:
    ...
    def __init__(self, filename, BytesIO) -> None:
        self._filename = filename
        self._decoder = Level0Decoder(BytesIO)
    ...
    def get_burst_data(self, burst: int) -> np.array:
        """
        ...
        return self._decoder.decode_packets(self.get_burst_metadata(burst))
